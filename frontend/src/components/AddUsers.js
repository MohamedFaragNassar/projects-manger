...
const AddUsers = ({ isOpen, close, project, errorHandler }) => {
  ...
  const [searchUsers, { data }] = useLazyQuery(searchUsersQuery);
  ...
  const handleAddUser = (e) => {
    ...
    setShowUsers([
      ...new Set([...showUsers, e.target.attributes.username.value]),
    ]);
  };
    ...
    <>
      ...
      <div className='add-users new-project '>
              ...
              <div className='add-users-form'>
                <input
                  ...
                  className={`search-input ${
                    data?.searchUsers?.length > 0 ? "show-res" : null
                  }`}
        ...
        <div className=' add-project-btns'>
          <button onClick={() => handleAddGroup()} className='confirm'>
            Add Members
          </button>
